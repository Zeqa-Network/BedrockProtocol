...
final class BiomeMesaSurfaceData{
	...
	public static function read(ByteBufferReader $in) : self{
		$clayMaterial = LE::readSignedInt($in);
		$hardClayMaterial = LE::readSignedInt($in);
	...
	public function write(ByteBufferWriter $out) : void{
		LE::writeSignedInt($out,  $this->clayMaterial);
		LE::writeSignedInt($out,  $this->hardClayMaterial);
