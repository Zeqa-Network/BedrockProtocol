...
final class BiomeScatterParamData{
	...
	public function write(ByteBufferWriter $out) : void{
		...
		LE::writeUnsignedShort($out, $this->chancePercent);
		...
		LE::writeUnsignedShort($out, $this->iterations);
	}
}
