...
final class BiomeConditionalTransformationData{
	...
	public static function read(ByteBufferReader $in) : self{
		...
		$conditionJSON = LE::readUnsignedShort($in);
		$minPassingNeighbors = LE::readSignedInt($in);
	...
	public function write(ByteBufferWriter $out) : void{
		...
		LE::writeUnsignedShort($out, $this->conditionJSON);
		LE::writeSignedInt($out,  $this->minPassingNeighbors);
	}
}
